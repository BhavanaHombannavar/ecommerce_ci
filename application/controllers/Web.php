...
class Web extends CI_Controller {
    ...
    public function save_cart() {
        ...
        $results = $this->WebM->get_product_by_id($product_id);
    ...
    public function customer_save() {
        ...
        if ($this->form_validation->run() == true) {
            $result = $this->WebM->save_customer_info($data);
            if ($result) {
    ...
    public function customer_logincheck() {
        ...
        if ($this->form_validation->run() == true) {
            $result = $this->WebM->get_customer_info($data);
            if ($result) {
    ...
    public function customer_shipping() {
        $data = array();
        $this->load->view('header');
        $this->load->view('customer_shipping');
        $this->load->view('footer');
    }
    ...
    public function save_shipping_address() {
        ...
        if ($this->form_validation->run() == true) {
            $result = $this->WebM->save_shipping_address($data);
    ...
    public function save_order() {
        ...
        if ($this->form_validation->run() == true) {
            $payment_id = $this->WebM->save_payment_info($data);
            $odata = array();
            ...
            $order_id = $this->WebM->save_order_info($odata);
            ...
            foreach ($myoddata as $oddatas) {
                ...
                $this->WebM->save_order_details_info($oddata);
            }
