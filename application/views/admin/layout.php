...
<html lang="en">
    ...
    <body>
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo base_url('admin/admin/logout')?>"><i class="halflings-icon off"></i> Logout</a></li>
                                </ul>
                            </li>
                            <!-- end: User Dropdown -->
                        </ul>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo base_url('dashboard')?>"><span class="hidden-tablet"> Dashboard</span></a></li>	
                            <li><a href="<?php echo base_url('admin/products/add')?>"><span class="hidden-tablet"> Add Product</span></a></li>
                            <li><a href="<?php echo base_url('admin/products/')?>"><span class="hidden-tablet"> List Product</span></a></li>
                            <!-- <li><a href="<?php echo base_url('manage/order');?>"><span class="hidden-tablet"> Manage Order</span></a></li> -->
                        </ul>
                    </div>
                </div>
                <!-- end: Main Menu -->
        ...
        <footer>
            ...
            <p>
                <span style="text-align:left;float:left">&copy; 2013 <a href="http://jiji262.github.io/Bootstrap_Metro_Dashboard/" alt="Bootstrap_Metro_Dashboard">Ecommerce</a></span>
